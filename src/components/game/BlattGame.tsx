    ...
    >
      ...
      <div className="flex items-center justify-between w-full max-w-[360px] mb-6">
        ...
        <Sheet>
          ...
          <SheetContent 
            side="right" 
            className="w-[280px] bg-[hsl(222,47%,11%)] border-l-2 border-gold/50" style={{ paddingTop: "env(safe-area-inset-top)" }}
          >
            <div style={{ height: "60px" }}></div><SheetHeader className="border-b border-gold/30 pb-4">
